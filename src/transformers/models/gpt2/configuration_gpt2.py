...
class GPT2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        bos_token_id=50256,
        eos_token_id=50256,
        token_classifier_type="linear",
        token_classifier_dropout=True,
        token_classifier_o_label_id=None,
        beta=1.0,
        use_subtoken_mask=True,
        alpha=0.5,
        use_NYT_rule=False,
        **kwargs
    ):
        ...
        self.token_classifier_type = token_classifier_type
        self.token_classifier_dropout = token_classifier_dropout
        self.token_classifier_o_label_id = token_classifier_o_label_id

        self.beta = beta
        self.use_subtoken_mask = use_subtoken_mask
        self.alpha = alpha
